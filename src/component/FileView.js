...
const FileView = (props) => {
  ...
  return (
    <div class="ui card">
      <div class="content">
        <div className="header" style={{"word-break":"break-all"}} data-tooltip={FileName}>
          {IsDir && <i class="folder open icon"></i>}
          {DisplayName}{" "}
        </div>
      </div>
      <div class="content">
      ...
      <div class="extra content ">
        {IsDir ? (
          ...
          // <a
          //   to={"http://192.168.1.27:9010/fs/downloadFileById?id=" + Id}
          //   target="_blank"
          ...
          // </a>
          <button className="ui button" onClick={downloadFile}></button>
        )}

        <div class="right floated author">
          <i class="trash alternate outline icon big"></i>
        </div>
      </div>
    </div>
  );
